...
declare module 'motia' {
  ...
  interface Handlers {
    'fetch-trending-videos': EventHandler<never, { topic: 'paidUser.trendVid.success'; data: never } | { topic: 'paidUser.trendVid.error'; data: never }>
    ...
    'FetchLatest-10-videos': EventHandler<never, { topic: 'paidUser.videosfetched.success'; data: never } | { topic: 'paidUser.videosfetched.error'; data: never }>
    ...
    'Fetch-Niche': EventHandler<never, { topic: 'paidUser.Nichefetched.success'; data: never } | { topic: 'paidUser.Nichefetched.error'; data: never }>
    'PaidUser-VerifyPayment': ApiRouteHandler<Record<string, unknown>, unknown, { topic: 'paidUser.payment.success'; data: never }>
    'send-email final metadata ': EventHandler<never, { topic: 'PaidUser.Email-Send.error'; data: never }>
    'PaidUser-CreateOrder': ApiRouteHandler<Record<string, unknown>, unknown, never>
    'fetch-AI-optimized metadata': EventHandler<never, { topic: 'paidUser.AImetadata.success'; data: never } | { topic: 'paidUser.AImetadata.error'; data: never }>
  }
