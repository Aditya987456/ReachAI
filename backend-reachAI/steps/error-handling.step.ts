...
//step-9: for notify that error caught


export const config= {
    name:"Error-handling",
    type:'event',
    subscribes:["yt.channel.error", "yt.videos.error","yt.niche.error",
        "yt.trendingVideos.error","yt.AI-Title.error","yt.titles.Email-Send.error" ],
