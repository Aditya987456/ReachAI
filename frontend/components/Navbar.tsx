...
export default function Navbar() {
  ...
  return (
    <header className="w-full bg-white sticky top-0 z-50 border-b border-gray-100 py-2 sm:py-3 md:py-3 lg:py-5">
      <div className="max-w-[1440px] mx-auto px-6 lg:px-28 flex justify-between items-center">
        {/* Logo */}
        <Link href="/">
        ...
        <nav className="hidden lg:flex items-center gap-8 text-base font-medium">
          ...
          <Link href="about" 
          className={path === "/about" ? "text-red-600 transition" :"hover:text-red-600 transition"}>
          About</Link>


          <Link href="contact" 
            className={path === "/contact" ? "text-red-600 transition" :"hover:text-red-600 transition"}>
            Contact</Link>
